...
const OfficerNavbar = () => {
  ...
  console.log("OfficerNavbar - userData:", userData);
      ...
      return [
        ...
        { 
          ...
          dropdown: [
            ...
            { path: "/officer/announcements", label: "ANNOUNCEMENTS" },
            { path: "/officer/campus-drives", label: "CAMPUS DRIVES" }
          ],
         },
  ...
  console.log("OfficerNavbar - dropdownStates:", dropdownStates);
